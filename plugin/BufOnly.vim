...
" :BufOnly [buffer]
"
" Close all hidden buffers in current tab
" :BufOnlyTab
"
...
" wipe hidden buffers in current tab
function! CloseTabHiddenBuffers()
  let i = 0
  let n = bufnr('$')
  while i < n
    let i = i + 1
...
" wipe hidden buffers - version which work for tabs
function! CloseHiddenBuffers2()
...
" based on tabpagebuflist
function! CloseHiddenBuffers3()
