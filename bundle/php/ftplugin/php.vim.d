" Поддержка PHP
"
" Все нормальное человечество давно использует PHP5,а не 4-ку. Но вот досада,
" ctags не умеет работать с PHP5 (имеется в виду private, public, protected,
" static методы). Этот недостаток призван исправить патч
" Скачайте исходники ctags, примените этот патч и перекомпилируйте ctags.
" Вуаля, всё заработало!
"
" Ниже приведёно содержание файла настроек, специфичных для PHP (
...
let g:pdv_cfg_Author = "seb <serebrov@gmail.com>"
